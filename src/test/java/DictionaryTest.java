...
class DictionaryTest {
    ...
    void testGetWord() {
        ...
        assertTrue(Dictionary.wordsWar()[0].containsKey(word), "Word should be present in the theme and level");

        word = Dictionary.getWord(2, 2);
        assertNotNull(word, "Word should not be null");
        assertTrue(Dictionary.wordsDev()[1].containsKey(word), "Word should be present in the theme and level");

        word = Dictionary.getWord(3, 3);
        assertNotNull(word, "Word should not be null");
        assertTrue(Dictionary.wordsReligion()[2].containsKey(word), "Word should be present in the theme and level");

        // Test with an invalid theme
        word = Dictionary.getWord(99, 1);
        assertNotNull(word, "Word should not be null");
        assertTrue(Dictionary.wordsWar()[1].containsKey(word), "Default theme and level should be used");
    }
    ...
    void testGetWordLength() {
        ...
        for (int i = 0; i < Dictionary.wordsWar()[0].size(); i++) {
            String word = Dictionary.getWord(1, 1);
        ...
        for (int i = 0; i < Dictionary.wordsDev()[1].size(); i++) {
        ...
        for (int i = 0; i < Dictionary.wordsReligion()[2].size(); i++) {
