...
public final class Dictionary {
    ...
    @Getter
    private static final List<Map<String, String>[]> THEMES = List.of(
        new Map[] {
            Map.of("title", "War"),
            Map.ofEntries(
        ...
        new Map[] {
            ...
            Map.ofEntries(
                ...
                Map.entry("driver", "A software component that allows the operating system"
            ...
            Map.ofEntries(
                ...
                Map.entry("internationalization", "Designing software to be adaptable"
        ...
        new Map[] {
            ...
            Map.ofEntries(
                ...
                Map.entry("tradition", "A belief or behavior passed down within"
                    + " a group or society with symbolic meaning."),
                Map.entry("devotional", "Related to prayer, worship, or devotion to a deity."),
                Map.entry("evangelism", "The spreading of the Christian gospel by"
            ...
            Map.ofEntries(
                ...
                Map.entry("reconciliation", "The act of restoring friendly relations, "
                    + "especially between God and humans."),
                ...
                Map.entry("dispensationalism", "A theological view that divides history "
    ...
    public static List<String> getAllThemes() {
        List<String> themes = new ArrayList<>(THEMES.size());
        for (Map<String, String>[] themeArray : THEMES) {
            Map<String, String> map = Arrays.stream(themeArray)
                .filter(m -> m.containsKey("title"))
                .findFirst()
                .orElse(Collections.emptyMap());
            themes.add(map.get("title"));
        }
        return themes;
    }
    ...
    public static String getWord(int theme, int level) {
        ...
        Map<String, String>[] chosenTheme = THEMES.get(realTheme);
        Map<String, String> chosenMap = chosenTheme[level];
    ...
    public static String getHint(int theme, int level, String word) {
        Map<String, String>[] chosenTheme = THEMES.get(theme);
        Map<String, String> chosenMap = chosenTheme[level];
